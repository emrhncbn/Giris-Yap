...
function Links({handleLogin}) {
  const isAuthenticated = useContext(AuthContext) // Kimlik doğrulama durumunu al
  ...
  const unAuthLinks = [
   ...
   // Kimlik doğrulama durumuna göre bağlantıları seç
